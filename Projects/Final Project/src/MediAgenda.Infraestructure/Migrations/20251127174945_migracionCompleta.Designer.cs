...
namespace MediAgenda.Infraestructure.Migrations
{
    ...
    [Migration("20251127174945_migracionCompleta")]
            ...
            modelBuilder.Entity("MediAgenda.Infraestructure.Models.DayAvailableModel", b =>
                {
                    b.HasOne("MediAgenda.Infraestructure.Models.ApplicationUserModel", "User")
                        .WithOne("DayAvailable")
                        .HasForeignKey("MediAgenda.Infraestructure.Models.DayAvailableModel", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
